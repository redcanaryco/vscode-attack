...
function buildPanel(technique: Technique): vscode.WebviewPanel {
	...
	let panel: vscode.WebviewPanel = vscode.window.createWebviewPanel('vscode-attack', `${technique.id}: ${technique.name}`, vscode.ViewColumn.One, {});
